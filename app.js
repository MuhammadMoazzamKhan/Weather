        ...
        <div class="modal-body px-3 py-3">
          ...
          <ul class="d-grid gap-4 my-5 list-unstyled small">
            <li class="d-flex gap-4">
              <svg class="bi text-body-secondary flex-shrink-0" width="48" height="48"><img src="https://ssl.gstatic.com/onebox/weather/64/fog.png" alt=""></svg>
              <div>
            ...
            <li class="d-flex gap-4">
              <svg class="bi text-warning flex-shrink-0" width="48" height="48"><img src="data:image/png;base64," alt=""></svg>
              <div>
